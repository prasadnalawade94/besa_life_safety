    ...
    <section id="catalog" class="container">
      ...
      <div class="supplier-grid">
        <div class="supplier-card">
          <a href="<?= page_url('eaton-products') ?>">
        ...
        <div class="supplier-card">
          <a href="<?= page_url('ekavis-products') ?>">
...
<div class="services-grid service-ion">
  ...
  <article class="service-card">
    ...
    <p>
      Preventive and corrective maintenance services with periodic inspection,
      testing, troubleshooting, and timely support for long-term system
      reliability.
    </p>
  </article>
  ...
  <article class="service-card">
    ...
    <h3>Fire Audit</h3>
    <p>
      Comprehensive fire safety audits to identify risks, assess existing
      systems, and provide practical recommendations for safety and compliance.
    </p>
  </article>
  ...
  <article class="service-card">
    ...
    <section id="projects" class="projects container">
      ...
      <div class="carousel-wrap">
        <button class="carousel-prev" data-target="projects" aria-label="Previous project">‹</button>
        <div class="projects-row carousel" data-carousel="projects">
